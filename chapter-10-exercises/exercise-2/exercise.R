...
salaries$got_raise <- salaries$salaries_2017 < salaries$salaries2018
...
biggest_paycut <- min(salaries$salsry_adjustments)
# What was the name of the employee who recieved largest decrease in salary?

got_biggest_paycut <- salaries[salaries$salary_adjustments == biggest_paycut, "employees"]
# What was the average salary change?

average_increase <- mean(salaries$salary_adjustments)
# For people who did not get a raise, how much money did they lose on average?

average_loss <- mean(salaries$salary_adjustments[salaries$got_raise == FALSE])
